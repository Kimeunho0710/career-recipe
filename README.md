...
1. **기초 연구 (관련 기술 및 개념 학습)**
   ...
   - **IT 직군별 정보 연구**  
     - 직업별 연봉 및 정보 , 로드맵 , 도움되는 자격증 조사 및 분석
   - **웹 개발 기술 학습**  
...
| **4주차** | 백엔드 개발 (1차)   <br> - Spring Boot (또는 Node.js) 프로젝트 초기 설정 <br> - 데이터베이스 구축 및 API 설계 <br> - 직업-과목 추천 알고리즘 개발 시작 |
...
| **8주차** | 기능 개선 및 추가 개발   <br> - 추천 알고리즘 보완 (피드백 반영) <br> - UI/UX 개선 <br> - 반응형 디자인 적용 |
